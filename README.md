...
4. [Guest Account Sprawl From "Helpful" Sharing Links](walkthroughs/04-guest-account-sprawl.md) — the same tenant setting causing two opposite problems: legitimate users blocked from inviting guests at all, and later, sprawl from the role granted to fix that; the security tradeoff behind the eventual fix.
...
17. [The License Count That Doubled Overnight — Stacking, Not a Gap](walkthroughs/17-license-benefit-stacking.md) — cross-referencing two different Microsoft views of the same tenant to find a structural, recurring licensing quirk instead of the coverage gap it looked like.
